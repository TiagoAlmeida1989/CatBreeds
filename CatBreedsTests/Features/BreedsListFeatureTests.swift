...
private extension Breed {
    static let abyssinian = Breed(
        ...
        image: BreedImage(
            id: "abys-image",
            url: URL(string: "https://example.com/abyssinian.jpg"),
            width: 640,
            height: 480
        )
    )

    static let bengal = Breed(
        id: "beng",
        name: "Bengal",
        ...
        image: BreedImage(
            id: "beng-image",
            url: URL(string: "https://example.com/bengal.jpg"),
            width: 640,
            height: 480
        )
    )

    static let maineCoon = Breed(
        id: "mcoo",
        name: "Maine Coon",
        origin: "United States",
        ...
        image: BreedImage(
            id: "mcoo-image",
            url: URL(string: "https://example.com/maine-coon.jpg"),
            width: 640,
            height: 480
        )
    )
